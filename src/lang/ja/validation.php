...
return [
    ...
    */
    ...
    'phone' => ':attribute に有効な電話番号を指定してください',
    ...
    */
    ...
    'attributes' => [],
    'shift' => [
        'invalid_shift_type' => "この操作を実行できません。現在のシフトステータスではシフトタイプを変更できません。",
        'invalid_shift_status' => '選択されたシフトステータスは、現在の役割では使用できません。',
        'staff_cannot_work_due_to_night_shift' => '前日に夜勤の勤務があるため、スタッフは選択された日に勤務することができません。',
        'staff_cannot_work_due_to_tomorrow_shift' => '翌日に勤務シフトがあるため、スタッフは選択された日に勤務することができません。',
    ],
    'care_plan' => [
        'care_plan_overlapping' => '利用者の予定が入っている為、<br/>この時間帯には移動できません。',
        'care_plan_in_canceled' => 'キャンセルされたタスクは時間変更できません。',
        'care_plan_in_done' => '実施完了タスクは時間変更できません。',
        'care_plan_update_success' => '更新完了しました。',
        'staff_cannot_work' => '従業員は、その時間帯にシフトがないため、選択した日に働くことができません。',
        'shift_type_not_found' => '選択した時間にシフト タイプが見つかりません。',
        'end_time_in_one_shift_type' => '終了時間は開始時間と同じシフト タイプ内にする必要があります。',
    ],
    'attachments' => [
        'max' => ':attribute は :max 個のファイルを超えることはできません。',
